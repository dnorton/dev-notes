...
- [Useful Unix Commands and Notes](#useful-unix-commands-and-notes)
	...
	- [Every Day Commands](#every-day-commands)
		...
		- [file permissions (`chmod`)](#file-permissions-chmod)
...
└───────────────────────── min (0 - 59)
```
([borrowed from http://ricostacruz.com/cheatsheets/cron.html](http://ricostacruz.com/cheatsheets/cron.html))
